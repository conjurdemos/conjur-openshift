...
declare template_file="haproxy.cfg.template"
declare destination_file="haproxy.cfg"
...
main() {
	...
	oc exec $haproxy_pod_name /start.sh
}
...
CONFIG
  ...
  for pname in $pod_list; do
    pod_ip=$(oc describe pod $pname | grep "IP:" | awk '{print $2}')
